...
Q: フシギダネのワザ「やどりぎのタネ」のエネコロチェックとキャラコロチェックに成功しました。
...
Q: フシギダネのHPが120の時に、フシギダネのワザ「ギガドレイン」のエネコロチェックとキャラコロチェックに成功しました。
...
Q: フシギダネのワザ「とつげき」のキャラコロ効果で、⾃分もダメージを受けて、おたがいのポケモンのHPが同時になくなりました。
この場合、勝敗はどうなりますか？
...
Q: ヒトカゲのワザ「ヒートアップ」のエネコロチェックとキャラコロチェックに成功しました。
...
Q: ヒトカゲのワザ「フレアストーム」のエネコロチェックとキャラコロチェックに成功しました。
出た炎エネルギーは5つでした。
...
Q: 前の自分の番にゼニガメのワザ「シェルアタック」のエネコロチェックとキャラコロチェックに成功しました。
次の相手の番、相手がフシギダネのワザ「つるのムチ」を使いました。
...
Q: 前の自分の番にゼニガメのワザ「シェルアタック」のエネコロチェックとキャラコロチェックに成功しました。
次の相手の番、相手がフシギダネのワザ「つるのムチ」を使い、エネコロチェックとキャラコロチェックに成功しました。
この場合、自分が受けるダメージは何ダメージですか？
...
Q: ピカチュウのワザ「エレキラッシュ」のエネコロチェックとキャラコロチェックに成功しました。
...
Q: ピカチュウのワザ「10まんボルト」のエネコロチェックとキャラコロチェックに成功しました。
...
Q: ピカチュウのワザ「ボルテッカー」のワザ効果で、⾃分もダメージを受けて、おたがいのポケモンのHPが同時になくなりました。
この場合、勝敗はどうなりますか？
...
Q: 相手がフシギダネのワザ「やどりぎのタネ」のエネコロチェックとキャラコロチェックに成功して、次の自分の番、自分が振れるエネコロが1個少なくなりました。
次の自分の番、エネコロが2個の状態で、ピカチュウのワザ「エレキラッシュ」のエネコロチェックとキャラコロチェックに成功しました。
...
Q: 先攻初回の番、エネコロが2個の状態で、ピカチュウのワザ「エレキラッシュ」のエネコロチェックとキャラコロチェックに成功しました。
続けて2回目の「エレキラッシュ」を使う時、自分が振れるエネコロの数は何個ですか？
...
Q: イーブイのワザ「とっしん」を使いました。
エネコロチェックは空エネルギー3つ、キャラコロチェックは{s1}でした。
この場合、相手に与えるダメージは何ダメージですか？
...
Q: イーブイのワザ「とっしん」のキャラコロ効果で、⾃分もダメージを受けて、おたがいのポケモンのHPが同時になくなりました。
この場合、勝敗はどうなりますか？
...
Q: ミュウのワザ「サイコキネシス」のエネコロチェックとキャラコロチェックに成功しました。
...
Q: 相手がピカチュウのワザ「かじる」のエネコロチェックとキャラコロチェックに成功して、自分が40ダメージを受けました。
次の自分の番、自分がミュウのワザ「リフレクション」のエネコロチェックとキャラコロチェックに成功しました。
この場合、相手に与えるダメージは何ダメージですか？
...
Q: カイロスのワザ「チャージばさみ」のエネコロチェックとキャラコロチェックに成功しました。
「次の自分の番、自分のエネコロを1個多くする。」とはどのように行いますか？
また、多くするエネコロを選ぶのは誰ですか？
...
Q: ファイヤーのワザ「ほのおのつばさ」のキャラコロ効果で、⾃分もダメージを受けて、おたがいのポケモンのHPが同時になくなりました。
この場合、勝敗はどうなりますか？
...
Q: フリーザーのワザ「アイスウイング」のキャラコロ効果で、次の相手の番、相手が振れるエネコロが1個少なくなりました。
少なくするエネコロを選ぶのは誰ですか？
...
Q: ヒトカゲのワザ「ヒートアップ」のキャラコロ効果で、次の自分の番、自分が振れるエネコロが2個多くなりました。
ただし、相手のフリーザーのワザ「コールドブレス」のキャラコロ効果で、次の自分の番、自分が振れるエネコロが2個少なくなりました。
...
Q: サンダーのワザ「サンダーチェイン」のエネコロチェックとキャラコロチェックに成功しました。
...
Q: イワークのワザ「ロックウォール」のエネコロチェックとキャラコロチェックに成功しました。
次の相手の番、相手がピカチュウのワザ「エレキラッシュ」を2回成功させました。
この場合、自分が受けるダメージは何ダメージですか？
...
Q: イワークのワザ「ロックウォール」のエネコロチェックとキャラコロチェックに成功しました。
次の相手の番、相手がサンダーのワザ「ボルトラッシュ」のキャラコロチェックを2回成功させました。
この場合、自分が受けるダメージは何ダメージですか？
...
Q: ベトベターのワザ「どくガス」を使いました。
エネコロチェックは成功、キャラコロチェックは失敗でした。
次の自分の番、ベトベターのワザ「どくどくボンバー」のエネコロチェックとキャラコロチェックに成功した場合、ダメージを追加することはできますか？
...
Q: 相手がピカチュウのワザ「エレキラッシュ」を使いました。
1回目のエネコロチェックとキャラコロチェックは成功、2回目のエネコロチェックは失敗でした。
次の自分の番、ベトベターのワザ「いやがらせベノム」のエネコロチェックとキャラコロチェックに成功した場合、ダメージを追加することはできますか？
...
Q: ルカリオのHPが120の時に、ルカリオのワザ「はどうナックル」のエネコロチェックとキャラコロチェックに成功しました。
この場合、ダメージを追加することはできますか？

A: いいえ、できません。
「はどうナックル」のキャラコロ効果でダメージを追加できるのは、HPが80以下のときだけです。

R: はどうナックル

#### 29

Q: ゲンガーのワザ「まっさかさま」のエネコロチェックとキャラコロチェックに成功しました。
「次の相手の番、相手のキャラコロの向きを{ht}にする。」とはどのように行いますか？

A: 次の相⼿の番、相⼿はキャラコロを振った後、{ht}にします。
これにより、相手が次の番に複数回キャラコロを振る場合でも、すべてのキャラコロの向きが{ht}になります。
...
Q: ゲンガーのワザ「まっさかさま」のエネコロチェックとキャラコロチェックに成功しました。
次の相⼿の番、相⼿がサンダーのワザ「ダブルサンダー」のエネコロチェックとキャラコロチェックを成功させました。
この場合、次の番に相手が振るキャラコロの向きはどうなりますか？

A: 次の番、相⼿が振るキャラコロの向きはすべて{ht}になります。
これにより、「ダブルサンダー」キャラコロチェックはすべて失敗となります。

R: まっさかさま, ダブルサンダー

#### 31

Q: メタグロスのワザ「しそくえんざん」のエネコロチェックに成功して、キャラコロで{st}が出ました。
次の相⼿の番、相手がゲンガーのワザ「まっさかさま」のエネコロチェックとキャラコロチェックを成功させました。
この場合、次の番に相手が振るキャラコロの向きはどうなりますか？

A: 「まっさかさま」のキャラコロ効果で、キャラコロの向きは{ht}になります。
...
Q: メタグロスのワザ「しそくえんざん」のエネコロチェックに成功して、キャラコロで{st}が出ました。
次の相⼿の番、相手がゲンガーのワザ「かげしばり」のエネコロチェックとキャラコロチェックを成功させました。
この場合、次の番に自分が振るキャラコロの向きはどうなりますか？

A: 「かげしばり」のキャラコロ効果で、キャラコロを振れなくなります。

R: しそくえんざん, かげしばり

#### 33

Q: メタグロスのワザ「だいばくはつ」のワザ効果で、⾃分もダメージを受けて、おたがいのポケモンのHPが同時になくなりました。
この場合、勝敗はどうなりますか？
...
Q: 相手のワザカードを見てから使うキャラコロとエネコロを選ぶことはできますか？

A: いいえ、できません。
キャラコロとエネコロは、バトルの準備中に同時に見せ合っておく必要があります。
バトルの準備が全て完了したら、ワザカード4枚を全てオモテにし、バトルをスタートしてください。

#### 40

Q: ワザの効果などでエネコロを振れる数が0個になった場合、どうすればよいですか？

A: 振れるエネコロが0個の番も、この番に使うワザを選択して、キャラコロだけを振ってください。
結果が出たら、この番は終了となります。
